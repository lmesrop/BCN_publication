...
python /home/lmesrop/programs/GO-Figure/gofigure.py -j standard-plus -i subset_Combined_TopGO_GO-Figure_DE_bothspecies.tsv -o gofigure_directory_DE_unique_bothspecies_si0.5 -si 0.5 -c user -m 50 -e 100 -q pdf
...
python /home/lmesrop/programs/GO-Figure/gofigure.py -j topgo -i df_TopGO_Skogsbergia_sp_DE_unique_Upper_Lip_BP.tsv -o gofigure_directory_DE_unique_skogsbergia_sp_si0.5 -si 0.5 -m 25 -e 100 -q pdf
