...
meta <- data.frame(row.names = colnames(vtsujii_skogs_joined_one_to_one_na_omit_cleanheaders)) 
...
dds_count_table <- DESeqDataSetFromMatrix(countData = vtsujii_skogs_joined_one_to_one_na_omit_cleanheaders, colData = meta, design = ~sample_name)
